...
class VGG_features(nn.Module):
    def __init__(
        ...
        self.features = self._make_layers(
            cfg, batch_norm, cfg_type, final_maxpool, final_relu
        )
    ...
    def _make_layers(
        self, cfg, batch_norm, cfg_type=None, final_maxpool=False, final_relu=False
    ):
        self.n_layers = 0

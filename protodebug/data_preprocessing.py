...
if __name__ == "__main__":
    ...
    if args.dataset_name == 'cub200':
        ...
        print(f'Cub200 images_dir {images_dir}', flush=True)
        print(f'Cub200 train_push_dir {train_push_dir}', flush=True)
        print(f'Cub200 test_dir {test_dir}', flush=True)
        print(f'Cub200 args.classes {args.classes}', flush=True)
        ...
        print(f'Cub200 train_dir {train_dir}', flush=True)
        print(f'Cub200 test_dir {test_dir}', flush=True)
        print(f'Cub200 train_push_dir {train_push_dir}', flush=True)
